...
class DDPM(pl.LightningModule):
    ...
    def loss(self, x):
        ...
        covariance_matrix = eps_pred@eps_pred.T/eps_pred.shape[1]
        identity_matrix = torch.eye(eps_pred.shape[0], device=eps_pred.device)  
        
        norm_loss = torch.norm(covariance_matrix - identity_matrix)**2
